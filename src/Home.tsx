...
export default function HomePage() {
  ...
  // Load anime from URL parameter if present
  useEffect(() => {
    const loadAnimeFromUrl = async () => {
      if (id) {
        try {
          ...
          const anime: AnimeData = {
            ...
            fullDescription: animeData.description,
            image: animeData.image || '',
            views: animeData.views,
            rating: animeData.rating,
            genres: animeData.genres,
            year: animeData.year || 2024,
            videoSrc: animeData.videoSrc || '',
            qualitySources: {},
            voiceovers: ['Оригинал'],
            comments: [],
          };
          ...
          // If anime not found, fall back to list view
          navigate('/');
        }
      }
    };
